...
public class Calc extends JFrame implements ActionListener {
  /** 数字ボタン. 0から9の10個 */
    ...
    /** 色の基準 */
    int co1 = 40;   /**関数の背景色、200以下で*/
    int co2 = 75;   /**数字の背景色、230以下で*/
    int co3 = 240;   /**演算の背景色の赤色、240以下で */
    int co4 = 150;  /**演算の背景色の緑色、190以下で */
    int co5 = 30;   /**演算の背景色の青色、190以下で */
 ...
 /** 電卓の表示を初期化する */
	...
	fuButton[2].setBackground(new Color(co1,co1,co1));
	fuButton[3].setBackground(new Color(co1+5,co1+5,co1+5));
	fuButton[6].setBackground(new Color(co1+10,co1+10,co1+10));
	fuButton[9].setBackground(new Color(co1+15,co1+15,co1+15));
	...
	fuButton[20].setBackground(new Color(co3,co4,co5));
	fuButton[19].setBackground(new Color(co3,co4,co5));
	fuButton[21].setBackground(new Color(co3,co4,co5));
	fuButton[22].setBackground(new Color(co3,co4,co5));
	fuButton[23].setBackground(new Color(co3+5,co4+5,co5+5));
	fuButton[20].setForeground(Color.black);
	fuButton[19].setForeground(Color.black);
	fuButton[21].setForeground(Color.black);
	fuButton[22].setForeground(Color.black);
	fuButton[23].setForeground(Color.blue);
	...
	fuButton[1].setBackground(new Color(co1+5,co1+5,co1+5));
	fuButton[4].setBackground(new Color(co1+10,co1+10,co1+10));
	fuButton[7].setBackground(new Color(co1+15,co1+15,co1+15));
	fuButton[18].setBackground(new Color(co1+20,co1+20,co1+20));
	...
	numButton[7].setBackground(new Color(co2,co2,co2));
	numButton[8].setBackground(new Color(co2+5,co2+5,co2+5));
	numButton[9].setBackground(new Color(co2+10,co2+10,co2+10));
	...
	clearButton.setBackground(new Color(co3+5,co4+15,co5+15));
	...
	fuButton[0].setBackground(new Color(co1+10,co1+10,co1+10));
	fuButton[5].setBackground(new Color(co1+15,co1+15,co1+15));
	fuButton[8].setBackground(new Color(co1+20,co1+20,co1+20));
	fuButton[17].setBackground(new Color(co1+25,co1+25,co1+25));
	...
	numButton[4].setBackground(new Color(co2+5,co2+5,co2+5));
	numButton[5].setBackground(new Color(co2+10,co2+10,co2+10));
	numButton[6].setBackground(new Color(co2+15,co2+15,co2+15));
	...
	opButton[0].setBackground(new Color(co3+5,co4+15,co5+15));
	opButton[0].setForeground(Color.black);
	opButton[1].setBackground(new Color(co3+10,co4+25,co5+25));
	opButton[1].setForeground(Color.black);
	c.gridwidth = 1;
	...
	fuButton[10].setBackground(new Color(co1+15,co1+15,co1+15));
	fuButton[13].setBackground(new Color(co1+20,co1+20,co1+20));
	fuButton[14].setBackground(new Color(co1+25,co1+25,co1+25));
	fuButton[15].setBackground(new Color(co1+30,co1+30,co1+30));
	...
	numButton[1].setBackground(new Color(co2+10,co2+10,co2+10));
	numButton[2].setBackground(new Color(co2+15,co2+15,co2+15));
	numButton[3].setBackground(new Color(co2+20,co2+20,co2+20));
	...
	fuButton[11].setBackground(new Color(co1+15,co1+15,co1+15));
	fuButton[12].setBackground(new Color(co1+20,co1+20,co1+20));
	fuButton[26].setBackground(new Color(co1+25,co1+25,co1+25));
	fuButton[16].setBackground(new Color(co1+30,co1+30,co1+30));
	...
	numButton[0].setBackground(new Color(co2+15,co2+15,co2+15));
	fuButton[24].setBackground(new Color(co2+20,co2+20,co2+20));
	fuButton[25].setBackground(new Color(co2+25,co2+25,co2+25));
	...
	opButton[2].setBackground(new Color(co3+10,co4+25,co5+25));
	opButton[2].setForeground(Color.black);

	c.gridheight = 1;
	add(opButton[3], c);

	opButton[3].setBackground(new Color(co3+15,co4+30,co5+30));
	opButton[3].setForeground(Color.black);

	c.gridy = 5;
	add(equalButton, c);

	equalButton.setBackground(new Color(co3+15,co4+35,co5+35));
