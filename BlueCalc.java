...
public class BlueCalc extends JFrame implements ActionListener {
    /** 数字ボタン. 0から9の10個 */
    ...
    /** 色の基準 */
    int co1 = 30;   /**関数の背景色、5以上195以下で*/
    int co2 = 60;   /**数字の背景色、160以下で*/
    int co3 = 40;    /** 演算の背景色、225以下で */


    /** メイン関数 */
    public static void main(String[] args) {
	Rireki rir = new Rireki();
	BlueCalc calc = new BlueCalc();
	rir.setVisible(true);	
	rir.expose();	
 ...
 /** 電卓の表示を初期化する */
	...
	fuButton[2].setBackground(new Color(co1-5,co1+20,co1+45));
	fuButton[3].setBackground(new Color(co1,co1+25,co1+50));
	fuButton[6].setBackground(new Color(co1+5,co1+30,co1+55));
	fuButton[9].setBackground(new Color(co1+10,co1+35,co1+60));
	...
	fuButton[20].setBackground(new Color(co3,co3,co3));
	fuButton[19].setBackground(new Color(co3,co3,co3));
	fuButton[21].setBackground(new Color(co3,co3,co3));
	fuButton[22].setBackground(new Color(co3,co3,co3));
	fuButton[23].setBackground(new Color(co3+5,co3+5,co3+5));
	...
	fuButton[1].setBackground(new Color(co1,co1+25,co1+50));
	fuButton[4].setBackground(new Color(co1+5,co1+30,co1+55));
	fuButton[7].setBackground(new Color(co1+10,co1+35,co1+60));
	fuButton[18].setBackground(new Color(co1+15,co1+40,co1+65));
	...
	numButton[7].setBackground(new Color(co2,co2+25,co2+50));
	numButton[8].setBackground(new Color(co2+5,co2+30,co2+55));
	numButton[9].setBackground(new Color(co2+10,co2+35,co2+60));
	...
	clearButton.setBackground(new Color(co3+10,co3+10,co3+10));
	...
	fuButton[0].setBackground(new Color(co1+5,co1+30,co1+55));
	fuButton[5].setBackground(new Color(co1+10,co1+35,co1+60));
	fuButton[8].setBackground(new Color(co1+15,co1+40,co1+65));
	fuButton[17].setBackground(new Color(co1+20,co1+45,co1+70));
	...
	numButton[4].setBackground(new Color(co2+5,co2+30,co2+55));
	numButton[5].setBackground(new Color(co2+10,co2+35,co2+60));
	numButton[6].setBackground(new Color(co2+15,co2+40,co2+65));
	...
	opButton[0].setBackground(new Color(co3+15,co3+15,co3+15));
	opButton[0].setForeground(Color.white);
	opButton[1].setBackground(new Color(co3+20,co3+20,co3+20));
	...
	fuButton[10].setBackground(new Color(co1+10,co1+35,co1+60));
	fuButton[13].setBackground(new Color(co1+15,co1+40,co1+65));
	fuButton[14].setBackground(new Color(co1+20,co1+45,co1+70));
	fuButton[15].setBackground(new Color(co1+25,co1+50,co1+75));
	...
	numButton[1].setBackground(new Color(co2+10,co2+35,co2+60));
	numButton[2].setBackground(new Color(co2+15,co2+40,co2+65));
	numButton[3].setBackground(new Color(co2+20,co2+45,co2+70));
	...
	fuButton[11].setBackground(new Color(co1+15,co1+40,co1+65));
	fuButton[12].setBackground(new Color(co1+20,co1+45,co1+70));
	fuButton[26].setBackground(new Color(co1+25,co1+50,co1+75));
	fuButton[16].setBackground(new Color(co1+30,co1+55,co1+80));
	...
	numButton[0].setBackground(new Color(co2+15,co2+40,co2+65));
	fuButton[24].setBackground(new Color(co2+20,co2+45,co2+70));
	fuButton[25].setBackground(new Color(co2+25,co2+50,co2+75));
	...
	opButton[2].setBackground(new Color(co3+20,co3+20,co3+20));
	opButton[2].setForeground(Color.white);

	c.gridheight = 1;
	add(opButton[3], c);

	opButton[3].setBackground(new Color(co3+25,co3+25,co3+25));
	opButton[3].setForeground(Color.white);

	c.gridy = 5;
	add(equalButton, c);

	equalButton.setBackground(new Color(co3+30,co3+30,co3+30));
