...
/**関数ボタンを生成するクラス**/
public class FuButton extends JButton implements MouseListener,KeyListener
{ 	
    /**割り当てられた演算記号**/
    ...
    /**  OpButtonのコンストラクタ.ボタンの作成を行う **/
    public FuButton(String str,DisplayedNumber number,ArithmeticUnit arithmUnit)
    {
	super(str);
	this.fuStr = str;
